...
-------------------------------------------------------------------------------------------------- 
	...
	inc_Exceptions <= Exception_accepted;--Complete. Total number of accepted exceptions
	inc_Mem_stalls <= not(IO_MEM_ready) and valid_I_MEM; --Complete. Structural Stall cycles due to multi-cycle memory references
	inc_EX_stalls <= not(ALU_ready) and valid_I_EX and IO_MEM_ready; --Complete. Structural Stall cycles generated by the multi-cycle MAC operaciones
